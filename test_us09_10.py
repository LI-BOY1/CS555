...
import datetime
import unittest
from SSW555_project import Person, Family, us09, us10

class test_us09_10(unittest.TestCase):
    def test_us09_10(self):
        """test for us09 us10"""
        """test for us07"""
        test_person1 = Person()
        test_person1.id = "I01"
        ...
        self.assertEqual(us09(person_list,family_list),'Correct')
        self.assertEqual(us10(person_list,family_list),'Correct')
